...
class MyTrackGraphWidget(QGraphicsView):
...
class MyTrackObject(QGraphicsItemGroup):
...
if __name__ == "__main__":
    ...
    window = MyMainWindow("Main Window")

    graph_lh = MyTrackGraphWidget(scene_size_x=500, scene_size_y=250)
    graph_lw = MyTrackGraphWidget(scene_size_x=500, scene_size_y=250)
    graph_wh = MyTrackGraphWidget(scene_size_x=250, scene_size_y=250)
    ...
    target1 = MyTrackObject("X1", Qt.darkRed)
